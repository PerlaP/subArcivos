(function (){
    ...
    publish.addEventListener('click', function(e){
        ...
        fetch('../../Suba de archivos/server.php',{
            method: 'POST',
            body: formData
        })
        ...
        /*ACA TENGO QUE CAMBIAR Y LLAMAR A SCRIPT/IMAGE.HTML UNA VEZ QUE FUNCIONE, MIESTRAS TANTO MUESTRA UNA LISTA DE LOS ARCHIVOS*/
        window.open('../../Suba de archivos/script/gallery.html');
